"""
You will need to finish the capture() function to take a picture at a given RPY angle. 
Make sure you have completed the sensor_calculations.py file before you begin this one.
"""
import time
import os
import board
